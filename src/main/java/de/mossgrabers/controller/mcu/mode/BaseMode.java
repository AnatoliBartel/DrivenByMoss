...
public abstract class BaseMode extends AbstractMode<MCUControlSurface, MCUConfiguration>
{
    ...
    public void updateFirstRow ()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            // TODO
            // this.surface.updateTrigger (MCUControlSurface.MCU_ARM1 + i, track.isRecArm () ?
            // MCUControllerSetup.MCU_BUTTON_STATE_ON : MCUControllerSetup.MCU_BUTTON_STATE_OFF);
            // this.surface.updateTrigger (MCUControlSurface.MCU_SOLO1 + i, track.isSolo () ?
            // MCUControllerSetup.MCU_BUTTON_STATE_ON : MCUControllerSetup.MCU_BUTTON_STATE_OFF);
            // this.surface.updateTrigger (MCUControlSurface.MCU_MUTE1 + i, track.isMute () ?
            // MCUControllerSetup.MCU_BUTTON_STATE_ON : MCUControllerSetup.MCU_BUTTON_STATE_OFF);
            // this.surface.updateTrigger (MCUControlSurface.MCU_SELECT1 + i, track.isSelected () ?
            // MCUControllerSetup.MCU_BUTTON_STATE_ON : MCUControllerSetup.MCU_BUTTON_STATE_OFF);
        }
